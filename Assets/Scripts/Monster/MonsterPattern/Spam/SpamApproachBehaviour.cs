...
[CreateAssetMenu(menuName = "Behaviours/Spam/Approach Player (Pixel Interval)")]
public class SpamApproachBehaviourSO : AttackBehaviourSO
{
    [Header("Approach")]
