...
/// �÷��̾� �������� "���� �Ÿ�(�簢 ����) ��"���� ����.
/// - ���̺�: �� spawnCountPerWave ������ ����
/// - ��ġ(����Ʈ): spawnBatchSize ������ �� ���� ����, ��ġ �� ���� spawnIntervalSeconds
/// - ������ 3�� ����ġ ���� ����
/// </summary>
public class WeightedOutOfRangeSpawner : MonoBehaviour
{
    ...
    private IEnumerator SpawnWaveCoroutine()
    {
        if (player == null)
        {
            Debug.LogError($"{nameof(WeightedOutOfRangeSpawner)}: Player�� ����ֽ��ϴ�.");
            _running = null;
            yield break;
        }
        ...
        {
            Debug.LogError($"{nameof(WeightedOutOfRangeSpawner)}: SpawnAreaHalf ���� NoSpawnHalf ������ Ŀ�� �մϴ�.");
            _running = null;
            yield break;
        }
        ...
        while (spawned < spawnCountPerWave)
        {
            ...
            for (int i = 0; i < toSpawnThisBatch; i++)
            {
                ...
                {
                    Debug.LogWarning($"{nameof(WeightedOutOfRangeSpawner)}: ��ȿ�� ���� ��ġ�� ã�� ���� 1ȸ ��ŵ�߽��ϴ�.");
                }
            }
